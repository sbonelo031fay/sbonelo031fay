...
#### 📊 [BestBrightness POS System](https://github.com/sbonelo031fay/BestBrightnessApp)
...
* **Focus:** An end-to-end data pipeline built to clean unstructured datasets and generate predictive insights through classification models.

#### 🃏 [CardClash](https://github.com/sbonelo031fay/CardClash)
* **Tech:** Java
* **Focus:** An exploration of Object-Oriented Programming (OOP) through a strategic battle engine.

---

### 📈 Currently Learning & Growing
* **Microsoft PL-300:** Mastering Data Modeling and Visualization in Power BI.
* **Enterprise Systems:** Deepening my understanding of B2B retail supply chain technology.
* **Cybersecurity:** Applying Google Professional Certificate principles to secure coding practices.
